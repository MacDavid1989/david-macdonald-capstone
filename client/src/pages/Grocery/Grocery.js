...
function Grocery() {
  ...
  const handleAddGrocery = (e) => {
    ...
    axios
      .post(`${SERV_URL}/groceries`, newUserItem(e, week))
      .then(() => getGroceries())
      .catch();
  ...
  const crossOffItem = (id, category) => {
    axios
      .put(`${SERV_URL}/groceries/${id}`, { category })
      .then(() => getGroceries())
      .catch();
  };
  ...
  return (
    <div className="grocery">
      ...
      <section className="grocery__user">
        <h2 className="grocery__user-title">Your Items</h2>
        {/* Add item form */}
        <form
          className="grocery__user-form"
        ...
        >
          ...
          />
          <input
            className="grocery__user-weight"
            required
            type="number"
            name="itemWeight"
            ...
            groceries.map(
              (grocery) =>
                ...
                grocery.week === week && (
                  ...
                  >
                    <span
                      onClick={() => crossOffItem(grocery.id, grocery.category)}
                      className={
                        grocery.isCompleted
                          ? "item__select-check"
                          : "item__select"
                    ...
                    >
                      <img
                        className="item__select-icon"
                        src={grocery.isCompleted ? check : undefined}
                        alt=""
                      />
                    </span>
                    <span
                      ...
                      style={{
                        textDecoration: grocery.isCompleted
                          ? "line-through"
                          : "none",
                      }}
                    >
      ...
      <section className="grocery__recipe">
        <h2 className="grocery__recipe-title">Recipe Items</h2>
            ...
            groceries.map(
              (grocery) =>
                ...
                grocery.week === week && (
                  ...
                  >
                    <span
                      onClick={() => crossOffItem(grocery.id)}
                      className={
                        grocery.isCompleted
                          ? "item__select-check"
                          : "item__select"
